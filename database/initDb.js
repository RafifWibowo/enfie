...
connection.connect(async (err) => {
  if (err) {
    ...
    try {
      ...
      await connection.query(`CREATE TABLE IF NOT EXISTS device (id INT PRIMARY KEY AUTO_INCREMENT, is_active BOOLEAN)`);
      ...
      await connection.query(`CREATE TABLE IF NOT EXISTS data (id INT PRIMARY KEY AUTO_INCREMENT, suhu FLOAT, tekanan FLOAT, e_nose FLOAT, kualitas_udara FLOAT, time TIMESTAMP DEFAULT CURRENT_TIMESTAMP, deviceId INT, FOREIGN KEY (deviceId) REFERENCES device(id) ON DELETE CASCADE)`);
